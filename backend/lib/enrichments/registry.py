...
from .rules import calculate_buckets, calculate_ldp_impacts, select_leg_amount
...
REGISTRY = {
    ...
    "leg_amount": EnrichmentDefinition("leg_amount", select_leg_amount, "rule", (A("eur_amount_0d"),), (A("security_leg_flag"), A("cash_amount_eur"), A("security_amount_eur"))),
    ...
    "ldp_impacts": EnrichmentDefinition("ldp_impacts", calculate_ldp_impacts, "rule", (A("ldp_impact_asset"), A("ldp_impact_asset_cash_gestion"), A("ldp_impact_inflow"), A("ldp_impact_outflow"), A("ldp_impact_lcr_reglementaire"), A("ldp_impact_lcr_gestion")), (A("security_leg_flag"), A("cash_amount_eur"), A("security_amount_eur"), A("lcr_inflow"), A("lcr_outflow"))),
}
